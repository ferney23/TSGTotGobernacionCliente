...
public class Test {
    ...
    public static void main(String[] args) {
         ...
         * :idEstudiante").setParameter("id",
         * 6763L).setParameter("idEstudiante", 209L).getResultList(); for
         * (Tareas tarea : tareas) { System.out.println(tarea.getNombreTarea());
         * }
         *
         ...
         * Materias(20000L, "Gerencia", "Gerencia", "Aprender de gerencia",
         * "uno")); // manageres.getTransaction().commit();
         ...
         * }
         *
         * //System.out.println(achivosTot + "Ferney si se puede"); *
         * //AchivosTot achivosTot = (AchivosTot) manageres.createQuery("SELECT
         * ma FROM AchivosTot ma WHERE ma.entrega.id= :id").setParameter("id",
         * 3L).getSingleResult();
         *
         *
         * //AchivosTot tareasAchivos = (AchivosTot)
         * manageres.createQuery("SELECT ma FROM AchivosTot ma WHERE
         * ma.idAchivosTot= :id").setParameter("id", 527789L).getSingleResult();
         *
         * //System.out.println(tareasAchivos);
         *
         *
         * // Tareas tareasAchiv = (Tareas) manageres.createQuery("SELECT ma
         * FROM Tareas ma WHERE ma.id= :id").setParameter("id",
         * 794L).getSingleResult();
         *
         * // Tareas tareas = manageres.find(Tareas.class, 794L);
         * //System.out.println(tareas.getSubida());
         *
         * //InfoGrado existeInfoGrado = (InfoGrado)
         * manageres.createQuery("SELECT ma FROM InfoGrado ma WHERE
         * ma.idInfoGrado= :id").setParameter("id", 1L).getSingleResult();
         * //System.out.println("Informacion del grado " + existeInfoGrado);
         * //Kiosko existeKiosco = (Kiosko) manageres.createQuery("SELECT ma
         * FROM Kiosko ma WHERE ma.idKisco= :id").setParameter("id",
         * 1L).getSingleResult(); // System.out.println("Informacion del kiosco
         * " + existeKiosco);
         *
         *
         * }
         *
         * //MaterialEstudio existe = manageres.find(MaterialEstudio.class,
         * 1L); //System.out.println(existe+ "ferney");
